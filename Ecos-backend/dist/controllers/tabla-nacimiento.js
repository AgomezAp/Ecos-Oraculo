        ...
        this.chatWithAstrologer = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const model = this.genAI.getGenerativeModel({
                    ...
                    generationConfig: {
                        temperature: 0.85, // ✅ Balance para interpretaciones astrológicas
                        topK: 50, // ✅ Mayor diversidad controlada
                        topP: 0.92, // ✅ Aumentado para mejor fluidez
                        maxOutputTokens: 600, // ✅ Aumentado de 800 para análisis completos pero controlados
                        candidateCount: 1, // ✅ Solo una respuesta
                        stopSequences: [], // ✅ Sin secuencias de parada
                    },
                    // ✅ CONFIGURACIONES DE SEGURIDAD PERMISIVAS PARA ASTROLOGÍA
                    safetySettings: [
                        {
...
Respuesta de la astróloga (asegúrate de completar TODO tu análisis astrológico antes de terminar):`;
                ...
                console.log(`Análisis de tabla de nacimiento generado exitosamente (${text.length} caracteres)`);
